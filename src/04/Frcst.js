...
const Frcst = () => {
    ...
    */
    ...
    /*let frcdt = [] ;
    frcdt.push(items[0].frcstOneDt, items[0].frcstTwoDt, items[0].frcstThreeDt, items[0].frcstFourDt) ;
    console.log(frcdt) ;

    let frccn = [] ;
    frccn.push(items[0].frcstOneCn, items[0].frcstTwoCn, items[0].frcstThreeCn, items[0].frcstFourCn) ;
    console.log(frccn) ; */
